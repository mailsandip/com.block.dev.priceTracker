sap.ui.require([
  ...
  var sViewName = "com.block.dev.priceTracker.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "com.block.dev.priceTracker"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title com.block.dev.priceTracker"
            });
        }
      }
